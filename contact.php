...
if (isset($_POST['fname'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $error_message = "Invalid email format"; // Set error message if email is invalid
    } else {
        ...
        <div class="lower">
            ...
            <div class="right">
                <form action="contact.php" method="POST">
                    ...
                    <div class="form">
                        <label for="msg">LANDMARK</label>
                        <br>
                        <textarea placeholder="Landmark" id="msg" name="msg" class="textbox"></textarea>
                    </div>
